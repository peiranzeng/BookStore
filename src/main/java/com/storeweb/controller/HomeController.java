...
import com.storeweb.service.impl.UserSecurityService;
import com.storeweb.utility.MailConstructor;
import com.storeweb.utility.SecurityUtility;
import com.storeweb.utility.USConstants;
...
public class HomeController {
	...
	public String remove(@ModelAttribute("id") Long userShippingId, Principal principal, Model model) {
		User user = userService.findByUsername(principal.getName());
	...
	public String updateUserInfo(@ModelAttribute("user") User user, @ModelAttribute("newPassword") String newPassword,
		...
		if (userService.findByUsername(user.getUsername()) != null) {
			if (userService.findByUsername(user.getUsername()).getId() != currentUser.getId()) {
				model.addAttribute("usernameExisits", true);
				return "myProfile";
			}
		}
