...
import com.storeweb.service.BillingAddressService;
...
public class CheckoutController {
	...
	@Autowired
	private UserPaymentService userPaymentServcie;
	...
	public String setPaymentMethod(
		...
		User user = userService.findByUsername(principal.getName());
		UserPayment userPayment = userPaymentServcie.findById(userPaymentId);
